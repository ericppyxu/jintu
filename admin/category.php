 ...
 * ============================================================================
 * $Author: 孤独三少 $
 * $Id: category.php 17217 2011-01-19 06:29:08Z 孤独三少 $
*/
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('goods_type_list',  goods_type_list(0)); // 取得房型类型
    $smarty->assign('attr_list',        get_attr_list()); // 取得房型属性
...
if ($_REQUEST['act'] == 'edit')
{
    ...
    if ($cat_info['filter_attr'])
    {
        ...
        foreach ($filter_attr AS $k => $v)
        {
            ...
            $filter_attr_list[$k]['goods_type_list'] = goods_type_list($attr_cat_id);  //取得每个属性的房型类型
    ...
    /* 模板赋值 */
    $smarty->assign('attr_list',        $attr_list); // 取得房型属性
