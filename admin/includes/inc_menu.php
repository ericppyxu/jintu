 ...
 * ============================================================================
 * $Author: 孤独三少 $
 * $Id: inc_menu.php 17217 2011-01-19 06:29:08Z 孤独三少 $
*/
...
$modules['02_cat_and_goods']['01_goods_list']       = 'goods.php?act=list';         // 房型列表
$modules['02_cat_and_goods']['02_goods_add']        = 'goods.php?act=add';          // 添加房型
$modules['02_cat_and_goods']['01_index_goods_list']       = 'index_goods_manage.php?act=list';         // 首页楼盘列表
...
$modules['02_cat_and_goods']['11_goods_trash']      = 'goods.php?act=trash';        // 房型回收站
$modules['02_cat_and_goods']['12_batch_pic']        = 'picture_batch.php';
$modules['02_cat_and_goods']['13_batch_add']        = 'goods_batch.php?act=add';    // 房型批量上传
$modules['02_cat_and_goods']['14_goods_export']     = 'goods_export.php?act=goods_export';
$modules['02_cat_and_goods']['15_batch_edit']       = 'goods_batch.php?act=select'; // 房型批量修改
...
$modules['08_members']['11_user_phone_manage']      = 'user_phone_manage.php?act=list';
$modules['08_members']['12_looking_house_manage']      = 'looking_house_manage.php?act=list';
$modules['08_members']['13_goods_phone_manage']      = 'goods_phone_manage.php?act=list';
$modules['08_members']['14_group_phone_manage']      = 'group_phone_manage.php?act=list';
...
$modules['10_priv_admin']['admin_role_manage']      = 'admin_role_manage.php?act=list';
