 ...
 * ============================================================================
 * $Author: 孤独三少 $
 * $Id: lib_goods.php 17217 2011-01-19 06:29:08Z 孤独三少 $
 */
...
/**
 * 从回收站删除多个房型
 * @param   mix     $goods_id   房型id列表：可以逗号格开，也可以是数组
 * @return  void
 */
 ...
 * 房型货号是否重复
 *
 * @param   string     $goods_sn        房型货号；请在传入本参数前对本参数进行SQl脚本过滤
 * @param   int        $goods_id        房型id；默认值为：0，没有房型id
 ...
 * 房型的货品规格是否存在
 *
 * @param   string     $goods_attr        房型的货品规格
 * @param   string     $goods_id          房型id
 * @param   int        $product_id        房型的货品id；默认值为：0，没有货品id
 * @return  bool                          true，重复；false，不重复
 */
 ...
 * 房型的货品货号是否重复
 *
 * @param   string     $product_sn        房型的货品货号；请在传入本参数前对本参数进行SQl脚本过滤
 * @param   int        $product_id        房型的货品id；默认值为：0，没有货品id
 * @return  bool                          true，重复；false，不重复
 */
